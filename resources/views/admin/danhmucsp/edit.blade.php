                        ...
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                ...
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('admin/danhmucsp/index')  }}">danh mục</a></li>
                    ...
                    <div class="col-md-8">
                      <div class="card card-product">
                        ...
                        <div class="card-body">
                          ...
                          <!--start form-->
                          <form action="{{ url('admin/danhmucsp/edit',$danhmucsp->id) }}" method="post" >
                            {{ csrf_field() }}
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <div class="form-group">
                                          <label for="tendanhmuc" class="bmd-label-floating">Tên Danh Mục</label>
                                          <input type="tendanhmuc" class="form-control" id="tendanhmuc" name="tendanhmuc" required="true" value="{{ $danhmucsp->tendanhmuc}}">
                                      </div>
                                      >
                                    </div>
                                    <div class="col-md-2"></div>
