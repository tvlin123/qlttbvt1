                ...
                <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Danh Sách Danh Mục</h1>
                    ...
                    <div class="col-md-12">
                      <div class="card ">
                        <div class="card-header border   " style="background-color: yellow">
                          <h4 class="card-title h3 text-center">Danh Mục</h4>
                        </div>
                        <div class="card-body">
                          <div class="toolbar">
                          ...
                          <div class="w-100" >
                            ...
                            <table class="table table-bordered " cellspacing="0" width="100%" style="width:100%">
                              <thead class="bg-primary text-white ">
                                <tr>
                                  <th class="text-center" style="width:15%">Mã Danh Mục</th>
                              ...
                              <tbody>
                                @foreach($danhsach as $list)
                                    <tr>
                                      ...
                                      <td class="text-center">{{ $list->tendanhmuc}}</td>
                                      <td class="text-right">
