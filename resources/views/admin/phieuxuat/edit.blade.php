                                ...
                                <div class="col-12">
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <div class="form-group">
                                            <label for="id_nguoixuat ">Màu</label>
                                      ...
                                      <div class="form-group">
                                          <label for="lydoxuat" class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
                                          <input type="text" class="form-control " id="lydoxuat" name="lydoxuat " required="true" value="{{ $phieuxuat->lydoxuat }}">
                                       </div>
                                       <div class="form-group">
                                          <label for="ngayxuat" class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
                                          <input type="text" class="form-control " id="ngayxuat" name="ngayxuat" required="true" value="{{ $phieuxuat->ngayxuat }}">
                                       </div>
                                       <div class="form-group">
                                          <label for="px_tongtien" class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
                                          <input type="text" class="form-control " id="px_tongtien" name="px_tongtien" required="true" value="{{ $phieuxuat->px_tongtien }}">
                                       </div>
                                       <div class="form-group">
                                          <label for="xuatcho" class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
                                          <input type="text" class="form-control " id="xuatcho" name="xuatcho" required="true" value="{{ $phieuxuat->xuatcho }}">
                                       </div>
                                       <div class="form-group">
                                          <label for="text " class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
                                          <input type="text" class="form-control " id="sdt" name="sdt" required="true" value="{{ $phieuxuat->sdt }}">
                                       </div>

                                        <div class="form-group">
                                          <label for="diachi" class="bmd-label-floating">Tên Hình Thức Xuất(*)</label>
