                            ...
                            <table class="table table-bordered " cellspacing="0" width="100%" style="width:100%">
                              <thead class="bg-primary text-white ">
                                <tr>
                                  ...
                                  <th class="text-center" style="width:20%">ly do </th>
                                  <th class="text-center" style="width:10%">ngay xuat </th>
                                  <th class="text-center" style="width:10%">nguoi xuat </th>
                                  <th class="text-center" style="width:10%">tong tien </th>
                                  <th class="text-center" style="width:10%">gia nhap </th>
                                  <th class="text-center" style="width:10%">gia xuất </th>
                              ...
                              <tbody>
                                @foreach($danhsach as $list)
                                    <tr>
                                      ...
                                      <td class="text-center">{{ $list->tenphieuxuat}}</td>
                                      <td class="text-center"><img src="{{url('public/upload/images/thumbs/Images/phieuxuat',$list->hinhanh) }}"></td>
