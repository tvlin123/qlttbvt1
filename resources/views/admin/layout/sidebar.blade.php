  <div class="left main-sidebar">
        ...
        <div class="sidebar-inner leftscroll">
            ...
            <ul>
                    ...
                    <li class="submenu">
                        <a href="index.html"><i class="fa fa-fw fa-bars"></i><span> Tranng Chủ </span> </a>
                    </li>

                    <li class="submenu">
                        <a href="{{url('admin/hinhthucxuat/index')  }}"><i class="fa fa-fw fa-area-chart"></i><span>Hình Thức Xuất</span> </a>
                    </li>
                     <li class="submenu">
                        <a href="{{url('admin/hinhthucnhap/index')  }}"><i class="fa fa-fw fa-area-chart"></i><span>Hình Thức Nhập</span> </a>
                    </li>
                    <li class="submenu">
                        <a href="{{url('admin/danhmucsp/index')  }}"><i class="fa fa-fw fa-area-chart"></i><span>Danh Mục Sản Phẩm</span> </a>
                    </li>
                     <li class="submenu">
                        <a href="{{url('admin/users/index')  }}"><i class="fa fa-fw fa-area-chart"></i><span>Tài Khoản</span> </a>
                    </li>
                    <li class="submenu">
