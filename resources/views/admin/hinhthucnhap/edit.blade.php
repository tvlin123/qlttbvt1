                ...
                <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Sửa Hình Thức Nhập</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item"><a href="{{url('admin/')  }}">trang chủ</a></li>
                                    <li class="breadcrumb-item"><a href="{{url('admin/danhmucsp/index')  }}">hình thức nhập</a></li>
                                    <li class="breadcrumb-item active">Sửa Hình Thức Nhập</li>
                                </ol>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <div class="form-group">
                                          ...
                                          <input type="tendanhmucsp " class="form-control " id="tendanhmucsp " name="tendanhmucsp " required="true" value="{{ $danhmucsp ->tendanhmucsp }}">
                                      </div>
                                      >
                                    </div>
                                    <div class="col-md-2"></div>
