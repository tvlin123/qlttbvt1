                ...
                <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left"> Danh Sách Hình Thức Xuất</h1>
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item"><a href="{{url('admin/')  }}">trang chủ</a></li>
                                    <li class="breadcrumb-item active"> hình thức xuất </li>
                                </ol>
                    ...
                    <div class="col-md-12">
                      <div class="card ">
                        ...
                        <div class="card-body">
                          ...
                          <div class="w-100" >
                             <a href="{{ url('admin/hinhthucxuat/create')}}" class="btn btn-danger btn-sm  m-2 shadow"><i class="fa fa-plus font-weight-bold">  Thêm </i></a>
                            <table class="table table-bordered " cellspacing="0" width="100%" style="width:100%">
                              <thead class="bg-primary text-white ">
                                <tr>
                                  ...
                                  <th class="text-center" style="width:70%">Tên Hình Thức Xuất </th>
                              ...
                              <tbody>
                                @foreach($danhsach as $list)
                                    <tr>
                                      ...
                                      <td class="text-center">{{ $list->tenhinhthucxuat}}</td>
                                      <td class="text-right">

                                        <a href="{{ url('admin/hinhthucxuat/edit',$list->id) }}" class="btn btn-link btn-warning btn-just-icon edit"><i class="fa fa-wrench"></i></a>
                                      ...
                                      <div class="modal-dialog modal-small">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer justify-content-center">
                                             ...
                                             <a  href="{{ url('admin/hinhthucxuat/delete',$list->id)}}" class="btn btn-danger">Có</a>
