                ...
                <!-- end row -->
                      ...
                      <div class="card card-product">
                        ...
                        <div class="card-body">
                          ...
                          <!--start form-->
                          <form action="{{ url('admin/sanpham/create') }}" method="post" >
                            {{ csrf_field() }}
                               ...
                               <!--end error-->
                                ...
                                <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control " id="tensanpham" name="tensanpham" required="true">
                                       </div>
                                       <div class="form-group">
                                          <label for="thongso" class="bmd-label-floating">Thông số(*)</label>
                                          <input type="text" class="form-control " id="thongso" name="thongso" required="true">
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control " id="soluong" name="soluong" required="true">
                                       </div>
                                        <div class="row">
                                            <div class="col-6">
                                                 <div class="form-group">
                                                  <label for="frk_gianhap" class="bmd-label-floating">Giá Nhập(*)</label>
                                                  <input type="text" class="form-control " id="frk_gianhap" name="frk_gianhap" required="true">
                                               </div>
                                            </div>
                                           <div class="col-6">
                                                <div class="form-group">
                                                  <label for="text " class="bmd-label-floating">Giá Xuất(*)</label>
                                                  <input type="frk_giaxuat " class="form-control " id="frk_giaxuat" name="frk_giaxuat" required="true">
                                               </div>
                                           </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <label for="hinhanh" class="bmd-label-floating">Hình Ảnh</label>
                                              <div class="input-group ">
                                                <input type="text" class="form-control" id="hinhanh"  name="hinhanh" required autocomplete="hinhanh" autofocus>
                                  ...
                                  <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <textarea name="mota" class="ckeditor form-control"></textarea>
                                           </div>
                                        </div>
                                  </div>
                                  <div class="row">
